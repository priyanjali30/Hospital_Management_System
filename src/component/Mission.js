        ...
        return (
            <div>
                ...
                <p className="text-white container">
                    The Mission of Hosiptal Management is to provide compassionate, accessible, high quality,
                ...
                <br />
                <p className="text-white container">
                    Hosiptal Management will be an innovative, leading regional health system dedicated to advancing the
